            ...
            switch (choice) {
                case 1:
                    ...
                    for (Account ac : accounts) {
                        if (ac.getAccountNumber() == updateAccountNumber) {
                            ac.updateDetails(updateAccountNumber);
                            break;
                        }
                    }
                    break;
                case 2:
                    ...
                    for (Account ac : accounts) {
                        if (ac.getAccountNumber() == getAccountNumber) {
                            ac.getDetails();
                            break;
                        }
                    }
                ...
                case 3:
                    ...
                    for (Account ac : accounts) {
                        if (ac.getAccountNumber() == depositAccountNumber) {
                ...
                case 4:
                    ...
                    for (Account ac : accounts) {
                        if (ac.getAccountNumber() == withdrawAccountNumber) {
