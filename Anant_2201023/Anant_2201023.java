...
class Admin extends User {
    ...
    public Admin(int userID, String name,String dateOfBirth, String address, String PAN,String dateOfJoining, double salary, int permissibleOperations) {
 ...
 public class Test {
    public static void main(String[] args) {
        ...
        if ("Admin".equalsIgnoreCase(userType)) {
            ...
            Admin adminUser = new Admin(1, adminName, "20/12/2002", "Admin Address", "AdminPAN", "01/01/2018", 50000, 3);
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 4:
                        ...
                        // Assuming date format "yyyy-MM-dd" for input
